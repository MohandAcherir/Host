...
export class GintermediateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.slides[0] = {
      ...
      ex2: '2. Tractions - 7x6 reps',
      ex3: '3. Squates - 7x6 reps',
      ex4: '4. Bench Press - 7x6 reps',
